package com.anu5priya7.pack_your_bag.Data;
...
public class AppData extends Application {
    ...
    public List<Items> getPersonalCareData(){
        ...
        "Razor Blade", "soap", "Fiber", "Shampoo", "Hair Conditioner", "Brush", "Comb", "Hair Dryer"
        ,"Curling Iron", "Hair Moulder","Hair Clip", "Moisturizer", "Lip Cream", "Contact Lens"
        ,"Perfume", "Deodorant", "Makeup Materials", "Makeup Remover","Wet Wipes", "Pad", "Ear Stick",
        "Cotton", "Nail Polish", "Nail Polish Remover", "Tweezers", "Nail Scissors", "Nail Files",
        "Suntan Cream"};
    ...
    public List<Items> getBabyNeedsData(){
        String[] data = { "Snapsuit", "Outfit", "Jumpsuit", "Baby Socks", "Baby Hat",
                "Baby Pyjamas", "Baby Bath Towel","Muslin", "Blanket", "Dribble Bibs",
                "Baby Laundry Detergent", "Baby Bottles", "Baby Food Thermos","Baby Bottle Brushes",
        "Brest-feeding Cover", "Breast Pump”, “Water Bottle","Storage Container","Baby Food Spoon",
       "Highchairs", "Diaper", "Wet Wipes", "Baby Cotton","Baby Care Cover","Baby Shampoo",
                "Baby soap","Baby Nail Scissors", "Body Moisturizer","Potty", "diaper Rash Cream",
                "Serum Physiological", "Nasal Aspirator","Fly Repellent Lotion","Pyrotmeter",
    ...
    public List<Items> getHealthData(){
        String[] data = {"Aspirin", "Drugs Used", "Vitamins Used","Lens Solutions", "Condom",
                ...
                "First Aid Kit", "Replacement Lens", "Pain Reliever", "Fever Reducer",
    ...
    String [] data = {"Mobile Phone", "Phone Cover", "E-Book Reader","Camera","Camera Charger",
            ...
            "Mouse","Extension Cable","Data Transfer Cable", "MP3 Player" ,"Battery",
            "Power Bank", "DVD Player", "Flash-Light","MP3 Player charger", "Voltage Adapter",
        "SD card"};
    ...
    public List<Items> getBeachSuppliesData(){
        String [] data = {"Sea Glasses", "Sea Bed", "Suntan Crean", "Beach Umbrella","Swim Fins",
                "Beach Bag", "Beach Towel","Beach Slippers","Sunbed", "Snorkel",
                "Waterproof Clock"};
        return prepareItemsList(MyConstants.BEACH_SUPPLIES_CAMEL_CASE,data);
    }

    public List<Items> getCarSuppliesData(){
        String [] data = {"Pump","Car", "Jack","Spare Car Key",
                "Accident Record Set","Auto Refrigerator", "Car Cover",
  ...
  public List<Items> getNeedsdata() {
      String[] data = {"Backpack", "Daily Bags", "Laundry Bag", "Sewing Kit",
              "Travel Lock", "Luggage Tag", "Magazine", "Sports Equipment",
              "Important Numbers"};
